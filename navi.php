<div id='navi' align='center'>
	...
	$naviItems = array("Startseite", "Bezirksräte", "Kontakt", "Dokumente");
	...
	foreach ($naviItems as $item)
	{
		...
		$httopic = str_replace('ä','ae',$item);
		$httopic = str_replace('ö','oe',$httopic);
		$httopic = str_replace('ü','ue',$httopic);
		$httopic = str_replace('ß','ss',$httopic);
		
		echo "<tab class='$class'><a class='$textClass' href=\"$httopic\">$item</a></tab>";
		$counter++;
	}
	?>
	&nbsp;<br><br>
